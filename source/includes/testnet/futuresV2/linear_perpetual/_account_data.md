...
```console
curl "https://api-testnet.bybit.com/public/linear/risk-limit?symbol=ETHUSDT"
```
...
## t(:lcp)
<a href="/doc-offline/futuresV2/inverse#t-lcp">t(:shared_endpoint_desc)</a>
